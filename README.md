About javaobj-py3-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/javaobj-py3-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2340&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/javaobj-py3-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `javaobj-py3` can be installed with `conda`:
...
```
mamba install javaobj-py3
```

It is possible to list all of the versions of `javaobj-py3` available on your platform with `conda`:
...
```
mamba search javaobj-py3 --channel conda-forge
```
...
mamba repoquery search javaobj-py3 --channel conda-forge

# List packages depending on `javaobj-py3`:
mamba repoquery whoneeds javaobj-py3 --channel conda-forge

# List dependencies of `javaobj-py3`:
mamba repoquery depends javaobj-py3 --channel conda-forge
```
